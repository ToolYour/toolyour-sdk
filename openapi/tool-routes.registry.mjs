...
export const toolGroups = [
  ...
  },
  {
    ...
    routes: [
      ...
      { method: "post", path: "/ai-ad-headline-variants", summary: "Deterministic ad headline variants", operationId: "aiAdHeadlineVariants", jsonBody: true },
      { method: "post", path: "/ai-email-subject-variants", summary: "Deterministic email subject variants", operationId: "aiEmailSubjectVariants", jsonBody: true },
    ],
  },
  {
